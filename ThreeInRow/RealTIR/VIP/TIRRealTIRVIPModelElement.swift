//
//  TIRRealTIRVIPModelElement.swift
//  ThreeInRow
//
...
class TIRRealTIRVIPModelElement: NSObject {
    var elementType: TIRElementMainTypes = .elementUndefined
    var coordinates: (row: Int, column: Int) = (0, 0)
    
    func isNeighbor(checkedElement: TIRRealTIRVIPModelElement) -> Bool//проверка, что ячейки являются соседями по горизонтали или вертикали
    {
